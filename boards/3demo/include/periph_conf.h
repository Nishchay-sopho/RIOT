...
/**
 * @name    SCD30 configuration
 * @{
 */
#define SCD30_PARAM_I2C_DEV         I2C_DEV(0)
#define SCD30_PARAM_I2C_ADDR        0x61
/** @} */
 ...
 * @{
 */
// Measurement mode in sdp31_reader
#define SDP3X_MODE SDP3X_MODE_CONTINUOUS

// Array define for 3 SDP3X sensors
#define SDP3X_PARAMS                { .i2c_dev       = I2C_DEV(0),  \
                                      .i2c_addr      = SDP3X_ADDR1, \
                                      .irq_pin       = GPIO_UNDEF }, \
                                    { .i2c_dev       = I2C_DEV(0),  \
                                      .i2c_addr      = SDP3X_ADDR2, \
                                      .irq_pin       = GPIO_UNDEF }, \
                                    { .i2c_dev       = I2C_DEV(0),  \
                                      .i2c_addr      = SDP3X_ADDR3, \
                                      .irq_pin       = GPIO_UNDEF }
/** @} */

/* Commented clock config because using stm32l4 cfg header file */
// /**
...
// #ifndef CONFIG_CLOCK_MSI_LSE_PLL
...
// #define CONFIG_CLOCK_MSI_LSE_PLL   (0)
// #endif

// /* give the target core clock (HCLK) frequency [in Hz], maximum: 80MHz */
// #define CONFIG_CLOCK_CORECLOCK     (80000000U)
